...
namespace Generico
{
    public partial class FrmConsultaClienteConstrucao : Form
    {
        private BindingSource binding;
        private DataTable table;
        public FrmConsultaClienteConstrucao()
        {
            InitializeComponent();
            init();
        }
        ...
        {
            FrmCadClienteConstrucao cad = new FrmCadClienteConstrucao(this);
            cad.Show();
        }
        ...
        private void FrmConsultaClienteConstrucao_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmPrincipal.lista_telas.Remove(2);
        }
    }
}
